...
ul,li,ol{ list-style: none; margin: 0; padding: 0; }
  input{ display: none; }
  .colorBtn{ width: 18px; height: 18px; }
  .colorBtn.disabled{ cursor: no-drop; }
  .box{
    position: absolute; width: 240px; background: #fff; border: 1px solid #ddd; visibility: hidden;z-index: 999; border-radius: 2px; margin-top: 2px; padding: 10px; padding-bottom: 5px; box-shadow: 0 0 5px rgba(0,0,0,.15); opacity: 0; transition: all .3s ease;
